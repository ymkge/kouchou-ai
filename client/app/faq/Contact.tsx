...
export default function Contact() {
  return (
    <>
    <Heading textStyle="heading/2xl" pt="12" pb="6">お問い合わせ</Heading>
    <Box
      padding="4px"
      ...
      <Box bg="white" borderRadius="2xl" p="8">
        <HStack gap="8">
          ...
          <VStack alignItems="flex-start" gap="4">
            <Text textStyle="body/md">このページで解決できなかった内容や、その他のご質問がございましたら、 デジタル民主主義2030のslackコミュニティのチャンネル「#6_ホストユーザー相談」でお気軽にお声がけください。チーム一同、迅速にサポートいたします。</Text>
